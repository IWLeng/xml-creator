rule_sets = {
    "1": {
        ...
        "rules": [
            ...
            (r'\bransomwaru\b', r'<phoneme alphabet="ipa" ph="raŋsomvɛːru">ransonwaru</phoneme>'),
			...
			(r'\b„O“\b', r'„<phoneme alphabet="ipa" ph="ˈoː">O</phoneme>“'),
    ...
    "6": {
        ...
        "rules": [
			...
			(r'\bPhishing\b', r'<phoneme alphabet="ipa" ph="ˈfɪʃɪŋ">Phishing</phoneme>'),
			(r'\bUsa \b', r'<phoneme alphabet="ipa" ph="ˈu.sa">usa</phoneme> '),
    ...
    "20": {
        ...
        "rules": [
			...
			(r'\be-mail-címen\b', r'<phoneme alphabet="ipa" ph="iːmeːl">e-mail</phoneme>-címen'),
			(r'\be-mail-címének\b', r'<phoneme alphabet="ipa" ph="iːmeːl">e-mail</phoneme>-címének'),
            (r'\be-mail-címét\b', r'<phoneme alphabet="ipa" ph="iːmeːl">e-mail</phoneme>-címét'),
			(r'\be-mail-címeket\b', r'<phoneme alphabet="ipa" ph="iːmeːl">e-mail</phoneme>-címeket'),
			...
			(r'\be-mailekre\b', r'<phoneme alphabet="ipa" ph="iːmeːlɛkɾɛ">e-mailekre</phoneme>'),
			(r'\bmalware-t\b', r'<phoneme alphabet="ipa" ph="mɒlvɛɾt">malware-t</phoneme>'),
            (r'\be-mailt\b', r'<phoneme alphabet="ipa" ph="iːmeːlt">e-mailt</phoneme>'),
			...
			(r'\bGratulálunk!\b', r'<prosody contour="(25%, +50%) (50%,-25%)" >Gratulálunk!</prosody>'),
			(r'\bféligazságok\b', r'<phoneme alphabet="ipa" ph="feːligɒz ʃaːgok">féligazságok</phoneme>'),
			(r'\bkisebbekre\b', r'<phoneme alphabet="ipa" ph="kiʃːɛbːɛkɾɛ">kisebbekre</phoneme>'),
			(r'\bluxusautók\b', r'<phoneme alphabet="ipa" ph="luksuʃ ɒutoːk">luxusautók</phoneme>'),
			(r'\bmegismer\b', r'<phoneme alphabet="ipa" ph="mɛgiʃmɛɾ">megismer</phoneme>'),
			(r'\badathalász\b', r'<phoneme alphabet="ipa" ph="ɒdɒthɒlaːs">adathalász</phoneme>'),
			(r'\bIT\b', r'<phoneme alphabet="ipa" ph="aːjti">IT</phoneme>'),
			(r'\bGDPR\b', r'<phoneme alphabet="ipa" ph="ʤidipiaːɾ">GDPR</phoneme>'),
			(r'\bkeylogging\b', r'<lang xml:lang="en-US">key-log-ing</lang>'),
			(r'\badathalászattal\b', r'<phoneme alphabet="ipa" ph="ɒdɒthɒlaːsɒtːɒl">adathalászattal</phoneme>'),
			(r'\badathalászatra\b', r'<phoneme alphabet="ipa" ph="ɒdɒthɒlaːsɒtɾɒ">adathalászatra</phoneme>'),
			(r'\bcredential stuffing\b', r'<phoneme alphabet="ipa" ph="krəˈdɛnʃəl ˈstʌfɪŋ">cridential stuffing</phoneme>'),
			(r'\b123456\b', r'<say-as interpret-as="number_digit">1 2 3 4 5 6</say-as>'),
			(r'\bMFA-t\b', r'<phoneme alphabet="ipa" ph="ɛmɛfaːt">MFA-t</phoneme>'),
			(r'\bPAN-t\b', r'<phoneme alphabet="ipa" ph="piːeːjɛnt">PAN-t</phoneme>'),
			(r'\bPCI DSS\b', r'<phoneme alphabet="ipa" ph="piːsiːaːjdeːɛsɛs">PCI DSS</phoneme>'),
			(r'\bdomainnevek\b', r'<phoneme alphabet="ipa" ph="domeːjnnɛvɛk">domainnevek</phoneme>'),
			(r'\bPII\b', r'<phoneme alphabet="ipa" ph="piːaːjaːj">PII</phoneme>'),
			(r'\badatsértéshez\b', r'<phoneme alphabet="ipa" ph="ɒdɒʧːeːɾteːʃhɛz">adatsértéshez</phoneme>'),
			(r'\bPrivileged Access Management\b', r'privilidzsd <phoneme alphabet="ipa" ph="ˈæksɛs">Access</phoneme> <phoneme alphabet="ipa" ph="ˈmænɪdʒmənt">Management</phoneme>'),
			(r'\bdeepfake\b', r'<phoneme alphabet="ipa" ph="ˈdiːp feɪk">deep-fake</phoneme>'),
